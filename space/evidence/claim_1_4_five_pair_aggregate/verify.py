"""Aggregate five frozen paper-scale paired iDDPM endpoint seeds."""
...
def main() -> None:
    ...
    input_checks = {
        ...
        "paper_scale_geometry": source["geometry"]["network_count"] == 1_000_000,
        "geometry_aggregate_checker_passed": source["geometry"][
            "aggregate_checker_passed"
        ],
        "leading_direction_stable": source["geometry"]["selected_direction_stability"][
            "0"
        ]["individual_direction_ready"],
        "smallest_direction_instability_disclosed": not source["geometry"][
    ...
    result = {
        "claims": [1, 4],
        "scientific_status": "PAPER_SCALE_FIVE_PAIR_ENDPOINT_CORROBORATION",
        "claim_verdict": "BLOCKED_PENDING_MULTI_DIRECTION_RANK_ASSOCIATION",
